...
class BaseTest extends TestCase {
    var $endPoint = "/base";
    public function testBaseNoArgument() {
    ...
    public function testBaseInsufficientArgument() {
    ...
    public function testBaseTrueTrueFalse() {
        # X = S => Y = D + ( D * E / 100 )
        $args = array(
    ...
    public function testBaseTrueTrueTrue() {
        # X = R => Y = D + ( D * ( E - F ) / 100 )
        $args = array(
    ...
    public function testBaseFalseTrueTrue() {
        # X = T => Y = D - ( D * F / 100 )
        $args = array(
    ...
    public function testBaseInvalidABCInput() {
    ...
    public function testBaseInvalidDEFInput() {
